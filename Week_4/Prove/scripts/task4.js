...
let myInfo = {
    name: 'Carson Bradford',
    photo: 'images/photo.png',
    favoriteFoods: ['Mofongo', 'Steak', 'Potatoes', 'Bratwurst'],
    hobbies: ['Riding dirtbikes', 'Fly Fishing', 'Camping', 'Tying Flies', 'Cooking']
};
